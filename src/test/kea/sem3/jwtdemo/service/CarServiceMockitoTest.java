...
class CarServiceMockitoTest {
    ...
    void testGetCars() {
        Mockito.when(carRepository.findAll()).thenReturn(List.of(
                new Car(CarBrand.VOLVO,"V70",100,10),
                new Car(CarBrand.VOLKSWAGEN,"Polo",100,10)
        ));
    ...
    void testGetCar() throws Exception {
        Car car = new Car(CarBrand.VOLVO,"V70",100,10);
        car.setId(1000);
    ...
    @Test
    void addCar() {
        Car carWithId = new Car(CarBrand.VOLVO,"V70",100,100);
